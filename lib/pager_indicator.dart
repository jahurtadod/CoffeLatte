...
import 'package:coffe_latte/pages.dart';
...
class PageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Container(
      ...
      child: new Center(
        child: new Container (
          width: lerpDouble(10.0, 25.0, viewModel.activePercent),
          height: lerpDouble(10.0, 25.0, viewModel.activePercent),
